(()=>{
  ...
  const icons = {
    ...
    veggie:'<g transform="translate(160 120) scale(.9) translate(-160 -120)"><path d="M214 70c-52 2-92 27-101 69-6 27 10 48 36 48 47 0 68-52 65-117Z"/><path d="M119 177c18-30 42-55 77-82"/><path d="M151 142c-3-16 0-30 7-44M170 125c14-1 27 2 39 8"/></g>',
