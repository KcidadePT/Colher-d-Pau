(()=>{
  ...
  const icons = {
    ...
    dessert:'<g transform="translate(160 120) scale(.86) translate(-160 -120)"><ellipse cx="160" cy="171" rx="59" ry="15"/><path d="M124 151V111l76-30v70Z"/><path d="M124 111l76-30 24 18-76 30Z"/><path d="M124 132l76-29M124 151l76-29"/><circle cx="177" cy="82" r="10"/><path d="M177 72c0-15 8-24 20-29"/></g>',
